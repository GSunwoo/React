/**
이벤트처리
  : HTML에서는 이벤트 리스너를 작성할 때 대소문자를 구분하지 않는다.
    하지만 React는 이벤트명의 첫글자를 반드시 대문자로 기술해야한다.
    또한 이벤트는 자식 컴포넌트가 부코 컴포넌트로 데이터를 전달하는
    용도로 사용한다.
 */
