  ...
  */
  ...
  open() 함수를 이용해서 채팅창을 팝업으로 오픈한다.
    형식] open(팝업창의 요청URL, 창의 이름, 창의 속성);
          두번째 인수인 '창의 이름'에 이름을 부여하면, 새로운 창을 열었을때
          항상 같은 위치에서 열리게 된다. 즉, 새로운 창을 열 수 없으므로 여기서는
          '창의 이름'을 부여하지 않아야한다.
  */
  const openChatWin = () => {
    /*
    useRef를 통해 참조한 input의 DOM을 이요해서 입력값을 얻어온다.
  ...
  return (<>
    ...
    방명 : <input type="text" name="roomId" value={roomName} ref={refRoom} onChange={(e)=>{
