...
useLocation 훅
: React Router를 통해 라우팅된 페이지에서 현재 URL(경로)과 관련된 정보를 얻는데
  사용된다. URL경로, 쿼리스트링 등의 관련정보를 제공한다.
useSearchParams
...
const RouterHooks = () => {
  ...
  // 쿼리스트링의 정보를 얻어오기 위한 변경을 위한 함수를 정의
  ...
  const changeMode = () => {
    ...
    /**
    ex6 에서는 객체 생성시 key와 value가 일치하면 하나의 값만 기술하면된다.
